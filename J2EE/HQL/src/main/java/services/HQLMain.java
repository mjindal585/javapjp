...
public class HQLMain {
	...
	public static void main(String[] args) {
	  ...
	  /*
		  ...
		  c=new HQL2("KL-07 AB234","Vento","Black","Volkswagen");
		...
		*/
		...
		/*HQL2DAO dao=new HQL2DAO();
		  HQL2 Operation
		  List<?> l=dao.DisplayAll("SELECT RegNo,Manufacturer FROM HQL2"); for(Objecta:l) System.out.println(String.valueOf(a));
		 */
